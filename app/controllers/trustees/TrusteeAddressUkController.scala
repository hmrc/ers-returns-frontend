...
class TrusteeAddressUkController @Inject()(val mcc: MessagesControllerComponents,
                                           ...
                                           trusteeNameView: views.html.trustee_address_uk,
                                          )
  ...
  def view(requestObject: RequestObject, groupSchemeActivity: String, index: Int, trusteeAddressUkForm: Form[TrusteeAddressUk])
          (implicit request: Request[AnyContent], hc: HeaderCarrier): Html = {
    trusteeNameView(requestObject, groupSchemeActivity, index, trusteeAddressUkForm)
  }
