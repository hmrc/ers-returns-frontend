...
class FrontendAccessibilitySpec extends AutomaticAccessibilitySpec {
  ...
  implicit val arbCompanyDetails: Arbitrary[Form[CompanyDetails]] = fixed(models.RsFormMappings.companyDetailsForm()(messages))
  implicit val arbReportableEvents: Arbitrary[Form[ReportableEvents]] = fixed(models.RsFormMappings.chooseForm()(messages))
  implicit val arbSchemeOrganiserDetails: Arbitrary[Form[SchemeOrganiserDetails]] = fixed(models.RsFormMappings.schemeOrganiserForm()(messages))
  ...
  override def renderViewByClass: PartialFunction[Any, Html] = {
    ...
    case manual_company_details: manual_company_details => render(manual_company_details)
    ...
    case scheme_organiser: scheme_organiser => render(scheme_organiser)
