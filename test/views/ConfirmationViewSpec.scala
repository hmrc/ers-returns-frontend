...
class ConfirmationViewSpec extends ViewSpecBase with FileUploadFixtures {
  ...
  private def hasExpectedElements(doc: Document, schemeRef: String): Unit = {
    ...
    doc
      ...
      .get(1)
      .text                                            mustBe "You must keep a copy of your Employment Related Securities annual return for your company records."
    ...
    doc
      ...
      .getElementsByTag("li")
      .get(0)
      .text                                            mustBe "your completed CSV or ODS file"
    doc
      .getElementsByClass("govuk-list govuk-list--bullet")
      .get(0)
      .getElementsByTag("li")
      .get(1)
      .text                                            mustBe "your submission receipt"
    firstElementByClassText(
      doc,
      "govuk-inset-text"
    )                                                  mustBe "You will not be able to get a copy of your records from HMRC at a later date."
    ...
    doc
      ...
      .getElementsByTag("li")
      .get(0)
      .text                                            mustBe "print or save a copy of your submission receipt (opens in a new tab)"
    doc
      .getElementsByClass("govuk-list govuk-list--bullet")
      .get(1)
      .getElementsByTag("li")
      .get(1)
      .text                                            mustBe "save your completed ODS or CSV file"
    doc
      .getElementsByClass("govuk-body")
      .get(4)
      .text                                            mustBe "Allow 48 hours before you check the status of your submission."
    doc
      .getElementsByClass("govuk-body")
      .get(5)
