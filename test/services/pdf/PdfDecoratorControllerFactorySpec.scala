...
class PdfDecoratorControllerFactorySpec
  ...
  lazy val ersSummary: ErsSummary = ErsSummary(
    ...
    isNilReturn = "",
    fileType = None,
    confirmationDateTime = ZonedDateTime.of(LocalDateTime.of(2016, 6, 8, 11, 45), ZoneId.systemDefault).toInstant,
  ...
  "When scheme is emi, pdf decorator controller factory" should {
    ...
    "add 5 decorators" in new TestPdfDecoratorControllerFactory {
      ...
      val ersSummary: ErsSummary = ErsSummary(
        ...
        "1",
        None,
        ZonedDateTime.of(LocalDateTime.of(2016, 6, 8, 11, 45), ZoneId.systemDefault).toInstant,
        metaData = Fixtures.EMIMetaData,
        None,
        None,
